...
# --- SETTINGS ---
model_filename = 'gfm_model_no_2025.pt'
filename_ending = "without2025"
district = "Nyagatare"
num_classes = 4 #XXXXX
...
model_ckpt = f"/cluster01/Projects/USA_IDA_AICCRA/1.Data/FINAL/Galileo/data/checkpoints/{model_filename}" #Model directory
patch_size = 8
stride = 4
